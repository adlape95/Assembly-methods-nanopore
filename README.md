...
Number of biosynthetic gene clusters (BGCs) predicted by antiSMASH for each draft assembly in the Even GridION datasets. (A) BGCs predicted for the 3 Gbps dataset; (B) BGCs predicted for the 6 Gbps dataset.
...
![Table S1](./tables/Table-S1-Canu.pdf)
**Table S1**. Canu’s basic assembly statistics for the GridION datasets.


![Table S2](./tables/Table-S2-flye.pdf)
**Table S1**. Flye’s basic assembly statistics for the GridION datasets.
